import diamondlogo from './diamondlogo.jpg'
...
import ln1 from './ln1.jpg'
import ln2 from './ln2.jpg'
import ln3 from './ln3.jpg'
import ln4 from './ln4.jpg'
import ln5 from './ln5.jpg'
import ln6 from './ln6.jpg'
import lngold1 from './lngold1.jpg'
import lngold2 from './lngold2.jpg'
import lngold3 from './lngold3.jpg'
import lngold4 from './lngold4.jpg'
import lngold5 from './lngold5.jpg'
import lngold6 from './lngold6.jpg'
import lnq1 from './lnq1.jpg'
import lnq2 from './lnq2.jpg'
import lnq3 from './lnq3.jpg'
...
{
    _id: "aaaaab",
    name: "LN LENQIN Mens Watches Waterproof Stainless Steel Watch for Men Analog Quartz Fashion Business Designer Wristwatch", 
    description: "•⌚【CLASSIC WATCHES FOR MEN】A stylish and classic design men watches with 46MM exquisite big face, quality quartz analog movement and battery, provide precise time. Whether you are at work, leisure or at a banquet, this mens watch will perfectly match any of your outfits.\n•⌚【 STAINLESS STEEL WATCHES FOR MEN】Elegant mens wrist watches comes with a soft and comfortable stainless steel case and strap, suitable for daily wear, non-oxidizing, easy to maintain. Foldover clasp with push button prevents accidental opening and falling, come with tool for adjustment different wrist sizes.\n•⌚【WATERPROOF WATCHES FOR MEN】Mens wrist watches is waterproof 30M/3ATM, suitable for sweat-proof, rain-proof and splash-proof, hand-wash. BUT NOT for bathing, swimming, diving, or immersion in water. Fashion and casual style, suitable for most indoor or outdoor activities.\n•⌚【PERFECT GIFT FOR MEN】The elegant appearance design makes this mens watches a perfect gift for your loved ones or yourself. An ideal gift for yourself, friends, classmates, father, lovers, family for Birthdays, Graduations, Father's Day, Valentine's Day, Thanksgiving ect.\n•⌚【WORRY-FREE PURCHASE】LN LENQIN WATCHES provides 90-day guarantee. 24-hour customer service for you, any questions please don't hesitate to contact us. We committed to offering a range of classic designer mens wrist watches and high standards of customer service.",
    price: 13,
    image: [ln1, ln2, ln3, ln4, ln5, ln6], 
    category: "Men",
...
},
{
    ...
    description: "• ⌚【CLASSIC WATCHES FOR MEN】A stylish and classic design men watches with 46MM exquisite big face, quality quartz analog movement and battery, provide precise time. Whether you are at work, leisure or at a banquet, this mens watch will perfectly match any of your outfits.\n• ⌚【 STAINLESS STEEL WATCHES FOR MEN】Elegant mens wrist watches comes with a soft and comfortable stainless steel case and strap, suitable for daily wear, non-oxidizing, easy to maintain. Foldover clasp with push button prevents accidental opening and falling, come with tool for adjustment different wrist sizes.\n• ⌚【WATERPROOF WATCHES FOR MEN】Mens wrist watches is waterproof 30M/3ATM, suitable for sweat-proof, rain-proof and splash-proof, hand-wash. BUT NOT for bathing, swimming, diving, or immersion in water. Fashion and casual style, suitable for most indoor or outdoor activities.\n• ⌚【PERFECT GIFT FOR MEN】The elegant appearance design makes this mens watches a perfect gift for your loved ones or yourself. An ideal gift for yourself, friends, classmates, father, lovers, family for Birthdays, Graduations, Father's Day, Valentine's Day, Thanksgiving ect.\n• ⌚【WORRY-FREE PURCHASE】LN LENQIN WATCHES provides 90-day guarantee. 24-hour customer service for you, any questions please don't hesitate to contact us. We committed to offering a range of classic designer mens wrist watches and high standards of customer service.",
    price: 13,
    image: [lngold1, lngold2, lngold3, lngold4, lngold5, lngold6], 
    category: "Men",
    subCategory: "Men watch",
    sizes: ["M", "L", "XL"],
    date: 15442556, 
...
},
{
    _id: "aaaaaf",
    name: "LN LENQIN Mens Watches Waterproof Stainless Steel Watch for Men Analog Quartz Fashion Business Designer Wristwatch", 
    description: "• ⌚【CLASSIC WATCHES FOR MEN】A stylish and classic design mens watches. 41MM exquisite big face, date display, quality quartz analog movement and battery, provide precise time. Whether you are at work, leisure or at a banquet, this mens watch will perfectly match any of your outfits. \n•⌚【STAINLESS STEEL WATCHES FOR MEN】Elegant mens wrist watches comes with a soft and comfortable stainless steel strap, suitable for daily wear, wear-resistant and scratch-resistant stainless steel case, non-oxidizing, easy to maintain. Double folding buckle prevents accidental opening and falling.\n• ⌚【WATERPROOF MENS WRIST WATCH】LN LENQIN watches for men is waterproof 50M/5ATM, suitable for sweat-proof, rain-proof and splash-proof, hand-wash. BUT NOT for bathing, swimming, diving, or immersion in water. Hard mineral glass dial scratch-resistant and the IP plating case never fade.\n• ⌚【PERFECT WATCH FOR MEN】The elegant appearance design makes this mens watches a perfect present for your loved ones or yourself. An ideal present for yourself, friends, classmates, father, lovers, family for Birthdays, Graduations, Father's Day, Valentine's Day, Thanksgiving ect.\n• ⌚【WORRY-FREE PURCHASE】MENS WATCHES provides 90-day guarantee. 24-hour customer service for you, any questions about mens watch, please don't hesitate to contact us. We committed to offering a range of classic designer mens wrist watches and high standards of customer service.",
    price: 20,
    image: [lnq1, lnq2, lnq3, lnq4, lnq5, lnq6], 
    category: "Men",
    subCategory: "Men watch",
    sizes: ["M", "L", "XL"],
    date: 15442556, 
