...
const Navbar = () => {
  ...
  return (
    <div className='flex items-center justify-between py-5 font-medium'>
     ...
     <Link to='/'><img src={assets.diamondlogo} className='w-40' alt="" /></Link> 
      ...
      <div className='flex items-center gap-2'>
        ...
        <div className='group relative'>
          <Link to='/login'>  <img className='w-6 sm:w-15 cursor-pointer  mx-3 flex-shrink-0' src={assets.profile_icon} alt="" /></Link>
